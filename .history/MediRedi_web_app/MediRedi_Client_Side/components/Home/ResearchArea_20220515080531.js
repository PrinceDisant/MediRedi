                        ...
                        return <div key={research.id} className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                           <div className={`research__item ${research.border ? research.border : ''} text-center mb-30 transition-3`}>
                              ...
                              <div className="research__content">
                                 ...
                                 <p>Our team of experts have done extensive research on how to get certified as a virtual physician in Newfoundland and have complied the best resourses for you</p>
                              </div>
                           </div>
                        </div>
                     })
