                              ...
                              <div className="row">
                                 ...
                                 <div className="col-xxl-7 col-xl-8 col-lg-8 col-md-10 col-sm-10">
                                    <div className="slider__content p-relative z-index-1">
                                       ...
                                       <p>We help doctors get certified to practice medicine remotely in NL and Canada believe everyone should have the opportunity to create progress through technolog.</p>
