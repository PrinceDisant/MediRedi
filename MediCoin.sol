...
*                                                                          
*           Telegram : https://t.me/ebcorp                                    
*           Twitter :  https://facebook.com/EBxClub                      
*                                                                          
*   ───────────────────────────────────────────────────────────────── 
*
*
...
struct User {
    ...
    constructor(){
        name = "EB.io"; // Sets the name of the token, i.e Ether
        symbol = "EB"; // Sets the symbol of the token, i.e ETH
    ...
    function _transfer(address sender, address recipient, uint256 amount, uint256 taxFeeInFunction, address toTaxInTransferFunction) internal {
        require(sender != address(0), "EB: transfer from the zero address");
        require(recipient != address(0), "EB: transfer to the zero address");
